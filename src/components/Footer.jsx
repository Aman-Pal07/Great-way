  ...
  return (
    <div className="bg-white text-center p-8">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        Cricketers, Olympic Medalists, Movie Stars have trusted them with their
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            For contribution towards uplifting the Indian garments & Lifestyle
            industry
          </p>
        </div>
        <div className="text-center">
          ...
          <p className="text-gray-600">
            By New Delhi Traders Association in 1996
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-center gap-8 border-t pt-8">
        <div className="text-center">
          <img
            src="https://cdn.shopify.com/s/files/1/0579/7930/6151/files/truck.svg?v=1683740610"
            alt="Free Shipping"
        ...
        <div className="text-center">
          <img
            src="https://cdn.shopify.com/s/files/1/0579/7930/6151/files/Cash-On-Delivery.svg?v=1683608367"
        ...
        <div className="text-center">
          <img
            src="https://cdn.shopify.com/s/files/1/0579/7930/6151/files/secured-payment.svg?v=1683608367"
            alt="Secured Payment"
            className="w-8 mx-auto mb-2"
          />
